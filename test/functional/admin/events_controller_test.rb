...
class Admin::EventsControllerTest < ActionController::TestCase
  ...
  test "should create admin_event" do
    assert_difference('Admin::Event.count') do
      post :create, admin_event: { address: @admin_event.address, body: @admin_event.body, datetime: @admin_event.datetime, featured: @admin_event.featured, title: @admin_event.title }
    end
  ...
  test "should update admin_event" do
    put :update, id: @admin_event, admin_event: { address: @admin_event.address, body: @admin_event.body, datetime: @admin_event.datetime, featured: @admin_event.featured, title: @admin_event.title }
    assert_redirected_to admin_event_path(assigns(:admin_event))
  end
